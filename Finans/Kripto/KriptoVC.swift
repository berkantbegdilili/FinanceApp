...
class KriptoVC: UIViewController {
    ...
    func setupData(){
        DispatchQueue.main.async {
            ...
            self.list = KriptoCek().kriptoOlustur()
...
extension KriptoVC: UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "KriptoTVCell", for: indexPath) as! KriptoTVCell
        ...
        cell.satisDolar.text = data.satisDolar!.replacingOccurrences(of: " ", with: "\n")
        cell.satisTurkLirasi.text = data.satisTurkLirasi!.replacingOccurrences(of: " ", with: "\n")
